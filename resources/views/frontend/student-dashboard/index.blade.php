        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <div style="height:100px" class="alert alert-primary d-flex align-items-center" role="alert">
                        <svg class="bi flex-shrink-0 me-2 h-75" role="img" aria-label="Info:">
                            <use xlink:href="#info-fill" />
                        </svg>
                        <div>
                            Hi, {{ auth()->user()->name }} your instructor request is pending. We will send a mail to your email when it will be approved.
                        </div>
                    </div>
                    <div class="row">
